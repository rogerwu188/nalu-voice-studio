...
acceptance remain incomplete; no SOP is promoted.
...
Native consumption and final audio/master/release remain open.
...
visible picker/offset restoration now exists in source, while current native QA,
take decisions and final sound/master QA remain incomplete. CI 34098405655 failed
the progress-file full-SHA audit; the value is corrected but current CI must pass.
...
GET-based recovery now exist in the preview panel source; current native QA and
actual sound/subtitle/master production remain open.
...
[Continuous shot tail input](qa/continuous-shot-tail-input-2026-09-07.md) now
...
[Saved edit recovery and sound retiming](qa/edit-recovery-and-sound-retiming-2026-09-07.md)
now restore same-source native drafts and derive backend sound/caption drafts from
...
concurrent-edit protection. [Native save-to-refresh orchestration](qa/native-director-refresh-2026-09-07.md)
...
Opening-frame preparation now [selects a documented matching-ratio resolution](qa/image-resolution-profile-2026-09-07.md)
