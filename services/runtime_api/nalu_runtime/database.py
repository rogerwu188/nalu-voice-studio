...
MIGRATIONS = (
    ...
    (
        ...
        """
        CREATE TABLE IF NOT EXISTS feedback_development_work_orders (
          feedback_id TEXT PRIMARY KEY REFERENCES feedback_items(id) ON DELETE CASCADE,
          request_sha256 TEXT NOT NULL,
          record_json TEXT NOT NULL,
          record_sha256 TEXT NOT NULL,
    ...
    (
        ...
        """
        CREATE TABLE IF NOT EXISTS feedback_development_handoff_reconciliations (
          feedback_id TEXT PRIMARY KEY REFERENCES feedback_items(id) ON DELETE CASCADE,
          request_sha256 TEXT NOT NULL,
          record_json TEXT NOT NULL,
          record_sha256 TEXT NOT NULL,
    ...
    (
        ...
        """
        CREATE TABLE IF NOT EXISTS feedback_development_results (
          feedback_id TEXT PRIMARY KEY REFERENCES feedback_items(id) ON DELETE CASCADE,
          request_sha256 TEXT NOT NULL,
          record_json TEXT NOT NULL,
          record_sha256 TEXT NOT NULL,
    ...
    (
        ...
        """
        CREATE TABLE IF NOT EXISTS feedback_release_evidence_reconciliations (
          feedback_id TEXT PRIMARY KEY REFERENCES feedback_items(id) ON DELETE CASCADE,
          request_sha256 TEXT NOT NULL,
          record_json TEXT NOT NULL,
          record_sha256 TEXT NOT NULL,
